...
def package_to_hub(repo_id,
  ...
  with tempfile.TemporaryDirectory() as tmpdirname:
    ...
    record_video(args.env_id, model, video_path, video_fps)
...
def record_video(env_id, model, path, fps=30):
    import imageio
    import numpy as np
    ...
    while not done:
        ...
        obs_np, reward, terminated, truncated, _ = env.step(action.cpu().numpy()[0])
        done = terminated or truncated
